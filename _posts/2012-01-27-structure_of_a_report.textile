 ...
 * other attempts include graphlab which uses a bulk asynchrounous processing model, but still lacks widespread production use as it has limited support for distributed computations 
...
Something about the research method(s) used. This is TBD.
